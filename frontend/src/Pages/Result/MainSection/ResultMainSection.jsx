...
function ResultMainSection() {
  return (
    <>
    <button className="text-[#161B2D] flex gap-4 px-8 cursor-pointer justify-center items-center py-2 rounded-full h-[52px] font-bold border-2 border-[#161B2D] ml-[10%] -mb-4 hover:bg-[#161b2d09]"><img src={back} alt="" className="w-8"/> Retry</button>
